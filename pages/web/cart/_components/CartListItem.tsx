...
const CartListItem = ({ key, item }: { key: string; item: any }) => {
  ...
  return (
    <div
      key={key}
      className="bg-white p-6 rounded-3xl border border-gray-100 mb-6 shadow-sm"
    >
      ...
      <div className="space-y-4">
        {item.ticketTypes.map((tt: any, idx: number) => (
          <div
            key={idx}
